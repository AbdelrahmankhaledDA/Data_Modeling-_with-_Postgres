...
def process_song_file(cur, filepath):
     """
                 This function can be used to read the file in the
...
def process_data(cur, conn, filepath, func):
     """
                 This function reads all file names in the filepath.
...
def main():
      """
                 This function connects to the database and provides the cursor.
